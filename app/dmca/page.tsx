  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: 'Liên hệ', body: 'Gửi yêu cầu DMCA tới email: dmca@bongmeow.com, hoặc dùng trang Góp ý. Chúng tôi sẽ xử lý và gỡ bỏ nội dung hợp lệ trong thời gian sớm nhất.' },
      ]}
    />
  )
}
